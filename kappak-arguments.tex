...
%% -autoPackageInclusion
\DeclareOption{-autoPackageInclusion}{
	\setboolean{@b_core_use_autoPackInclusion}{false}
	\PackageWarning{kappak_v4}{-autoPackageInclusion called, no package will be included by kappak, except ifthen and keyval}
}
...
\ifthenelse{\boolean{@b_core_use_autoPackInclusion}}{
	...
	\hypersetup{ % Thanks timmurphy.org
	    colorlinks=true,
	    linkcolor=blue,
	    urlcolor=red,
	    linktoc=all
